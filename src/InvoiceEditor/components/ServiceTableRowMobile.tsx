...
import { Project, Service } from '../../models/project.model';
...
type ServiceTableRowMobileProps = {
    service: Service;
    projectId:number;
    client: Client;
    index: number;
}
const ServiceTableRowMobile = ({ service, projectId, client, index }:ServiceTableRowMobileProps) => {
