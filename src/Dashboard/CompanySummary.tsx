...
const CompanySummary = ({ clients }: CompanySummaryProps) => {

    const allProjectsTotalArray:number[] = []
    const allProjectsTotalPaidArray:number[] = []

    console.log(allProjectsTotalPaidArray)
    let totalInvoices = 0
